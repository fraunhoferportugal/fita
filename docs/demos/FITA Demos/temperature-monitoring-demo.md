...
![Temperature Monitoring Demo High-level Overview](../../static/img/temperature-monitoring-demo/temperature_monitoring_demo.svg)

### Demo Components

#### FITA [![Link](../../static/img/link.svg)](/docs/intro)

Enables the integration of Far-Edge devices equiped with temperature sensors that transmit real-time data in a Kubernetes cluster. Explore more about FITA in the [Docs](/docs/intro) page.

#### InfluxDB [![Link](../../static/img/link.svg)](https://www.influxdata.com/)
...
#### Prometheus [![Link](../../static/img/link.svg)](https://prometheus.io/)
...
#### Grafana [![Link](../../static/img/link.svg)](https://grafana.com/)
...
1. FITA deployment
    - You can also follow the [Installing FITA](/docs/getting-started/intro#fita) guide
...
![Temperature Monitoring Demo High-level Overview](../../static/img/temperature-monitoring-demo/grafana_dashboard.png)
