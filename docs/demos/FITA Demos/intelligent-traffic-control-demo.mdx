...
![Intelligent Traffic Control Demo High-level Overview](../../static/img/intelligent-traffic-control-demo/intelligent_traffic_control_system.svg)
...
Enables the integration of Far-Edge devices equiped with noise sensors and cameras that transmit real-time data in a Kubernetes cluster. Explore more about FITA in the [Docs](/docs/intro) page.
...
- [Intelligent Traffic Control Monitoring Dashboard](#intelligent-traffic-control-monitoring-dashboard) 
...
![Intelligent Traffic Control Demo High-level Dashboard](../../static/img/intelligent-traffic-control-demo/grafana_dashboard.png)
